...
//Added for email and password field validation
...
//extends AppCompatActivity
    ...
    /*We know that if this method is called, the user doesn’t need the keyboard anymore.
     Unfortunately, Android doesn't hide the virtual keyboard automatically, unless you tell it to
    */
    ...
    public boolean validatePassword(final String password) {
        ...
        return password.length() > 7 && pass_matcher.matches();
    }
    /**
